Pod::Spec.new do |s|
  s.name             = 'GKImagePicker-iOS'
  s.version          = '1.0.0'
  s.summary          = 'Image Picker easy for usage. Compatible with both Swift and Objective-C.'

  s.homepage         = 'https://github.com/janlionly/GKImagePicker-iOS'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'janlionly' => 'janlionly@gmail.com' }
  s.source           = { :git => 'https://github.com/janlionly/GKImagePicker-iOS.git', :tag => s.version.to_s }
